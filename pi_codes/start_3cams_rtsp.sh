...
start_cam "cam2" "/dev/v4l/by-id/usb-Camera_Vendor_Conference_Camera_00.00.01-video-index0" "0" "h264"
start_cam "cam3" "/dev/v4l/by-id/usb-Microsoft_Microsoft®_LifeCam_HD-3000-video-index0" "0"
  ...
  for name in cam1 cam2 cam3; do
    ...
    if ! kill -0 "$pid" 2>/dev/null; then
      ...
      case $name in
        ...
        cam2) start_cam "cam2" "/dev/v4l/by-id/usb-Camera_Vendor_Conference_Camera_00.00.01-video-index0" "0" "h264" ;;
        cam3) start_cam "cam3" "/dev/v4l/by-id/usb-Microsoft_Microsoft®_LifeCam_HD-3000-video-index0" "0" ;;
      esac
    fi
  done
done
