...
\subsection{Kamera Agent-Rasberry pi}
    ...
    Ezek nélkül a rendszer nem valósulhatna meg.
        ...
        \begin{figure}[H]
            \centering
            {\includegraphics[width=0.8\textwidth]{figures/images/literature/mediamtx_pipeline.jpg}}
    ...
    Az infrastruktúra felépítéséhez Terraform keretrendszert használtunk.
        ...
        skálázhatóan futnak.\cite{gcp} Mindhárom függvény az \texttt{sa-alert-manager} illetve \texttt{sa-dispatcher} service account jogosultságaival rendelkezik.
        ...
        Az \texttt{alerts} kollekció tárolja a detektált anomáliák bejegyzéseit. Mezői: \texttt{camera\_id} (melyik kamera észlelte),
        ...
        Az \texttt{alert\_cooldowns} kollekció az e-mail értesítések visszatartási idejét kezeli kameránként,
        megakadályozva a riasztás-özönt rövid időn belül ismétlődő anomáliák esetén.

        A \texttt{budget\_alerts} kollekció a GCP költségvetési riasztásokat naplózza, beleértve a felhasznált összeget,
        ...
        \begin{figure}[H]
            \centering
            {\includegraphics[width=0.8\textwidth]{figures/images/literature/judge_cicd_pipeline.jpg}}
    ...
    melyek a megfelelő kódváltozásra automatikusan lefutnak, csökkentve a manuális beavatkozás szükségességét és az emberi hibák esélyét.\cite{github_actions}
        ...
        \begin{figure}[H]
            \centering
            {\includegraphics[width=0.8\textwidth]{figures/images/literature/github_actions_cicd.jpg}}
