...
\subsection{Kamera Agent – Raspberry Pi}
    ...
    A Raspberry OS pedig tökéletes a szükséges docker konténerek és python scriptek futtatására.
    ...
    Az infrastruktúra felépítéséhez Terraform keretrendszert használtunk.
        ...
        kommunikálhatnak a Google Api-val, emberi felhasználók helyett, ezzel biztonságos összeköttetést biztosítva a különböző erőforrások között.
            ...
            Feladata, hogy elosztja a streameket, és meghívja a VertexAi endpointot. Jogosultságai, hogy aiplatform felhasználó, pub/sub feliratkozó a detections-out csatornán, és
            aktiválhatja az Alert-managert szükség esetén
