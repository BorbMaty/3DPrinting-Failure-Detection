...
környezetben futó YOLOv8 neurális hálózat dolgozza fel. A modell egy saját annotált adathalmazon került betanításra, és 9 hibaosztály felismerésére képes, és 92.6\% mAP50 pontossággal
és 87.3\% recall értékkel rendelkezik, illetve másodpercenként 3 képkockát dolgoz fel 23 ms inferencia idővel.
...
\textbf{Kulcsszavak}: 3D nyomtatás,konvoluciós neuronháló, yolov8x, rasberry pi, Google Cloud, vertexAI, webkamera, hiba, additív gyártás, terraform, docker, firebase, cvat, python \\