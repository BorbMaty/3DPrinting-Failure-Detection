    ...
    \subsection{Főbb karakterisztikák}
        A Yolov8 keretrendszerhez az Ultralytics teljes mértékben újragondolta a rendszer architektúráját,
        A Pytorch helyett most más saját fejlesztésű rendszert használ, ennek segítségével a modell gyorsabb és stabilabb lett, viszont a
        Yolov5 felé visszafele inkompatibilitást jelent. Ezen keretrendszer támogat az obiektum detekción kivűl, szegmentálást, pozició becslést, obiektum osztályozást és követést is egyaránt.
        A tanítás és detekció most már nem igényel segéd scripteket sem, minden API hívásokkal valósul meg a CLI-n keresztül.
        Ugyanitt lehetőségünk van a modellünk exportálására olyan formátumokba, mint az ONNX, CoreML, és TensorRT.
    ...
    \begin{table}[H]
    \centering
    \caption{YOLOv8 modell variánsok}
    ...
    \begin{tabular}{|l|l|p{0.55\textwidth}|}
        ...
        \hline
        \texttt{yolov8s} & Small      & Kis méretű modell, gyors interferenciával, alacsony erőforrásigénnyel. \\
        \hline
...
results.show()
    ...
    A \texttt{data.yaml} konfigurációs fájl tartalmazza az adathalmaz elérési útjait és az osztálycímkéket:
...
names: ['stringing', 'warping', 'layer_shift', 'under_extrusion',
    ...
    \end{lstlisting}
        ...
        Tanítási folyamat elindítása parancssoron keresztül:
...
<class_id> <x_center> <y_center> <width> <height>
    ...
    \subsection{Célkítűzés}
    Mivel a keretrendszer és az erőforrások is adottak voltak, így a választás a yolov8x alapmodelre esett, a célkítűzés tiszta, 
    egy olyan modelt betanítani mely képes élő kamera bemeneten felismerni a 9 hiba bármelyikét, és annak egy olyan keretrendszerbe illesztése,
    mely ezt elegáns módon lehetővé teszi.
