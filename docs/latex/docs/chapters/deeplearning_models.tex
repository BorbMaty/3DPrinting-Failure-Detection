    ...
    \subsection{A modell által nyújtott előnyök a projekt megvalósításához}
    
    \begin{itemize}
        \item Valós idejű hibadetektálás, videó bemeneten
        \item A tanítás folyamata nem bonyolult többszörösen megismételhető, amennyiben ezt a helyzet megkívánja.
        \item A pontosság, nem sínyli meg a felhasznált modell méretét, a kis méretű modellek is képesek magas pontosságot produkálni.
        \item Támogatott integráció konténerizációs környezetbe (docker).
    \end{itemize}