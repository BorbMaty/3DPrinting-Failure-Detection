...
A 3D nyomtatási folyamatok automatizált hibdetekciójának kutatása az elmúlt évtizedben kiemelkedő
...
\section{Képalapú megközelítések}
    ...
    megállítására vagy a nyomtatási paraméterek korrekciójaárat. A tanulmány hangsúlyozza, hogy
    ...
    jellemzőleíró kombináció először extrahál potenciális hibarégiót, majd pontszomszédsági számítással
...
tanulmány nem 3D nyomtatásra, hanem acélfelületek hibadetekcójára fókuszál, módszertanilag
...
hibadetekcójához hasonló körülmények között -- megbízhatóan alkalmazható. A többléptékű
...
nézőpontjaiból érkező képek együttes feldolgozásával robosztusabb detekciós rendszer valósuljon meg.
