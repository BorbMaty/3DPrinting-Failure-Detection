...
\subsection{Iparági relevancia és nyersanyagmenedzsment}
A 3D nyomatás a jelenben már egy igen komoly iparággá nőtte, ki magát, tekintettel lévén arra, hogy 
Rengeteg új geometria megvalósítására nyitott kapukat, az additív gyártásban, és rendkívűl egyszerűvé tette a 
...
\begin{figure}[h]
    ...
    \caption{3D nyomtató farm\protect\footnotemark}
\end{figure}
\footnotetext{\textit{3D nyomtató farm}: \url{https://www.voxelmatters.com/the-rise-of-3d-printer-farms/}}

Egy ilyen farm esetén, már egy szeletelési hiba is, ha észrevétlen marad anyagi kárral, nyersanyagveszteséggel
vagy a berendezések sérülésével járhat. A 3D nyomtatási folyamatok egyik nagy problámája az, hogy igen csak időigényesek, és a nagyszámok törvénye alapján
a hibák bekövetkezésének esélye is növekszik.
A projekt keretein egy olyan skálázható rendszert szeretnénk megvalósítani, mely képes minden nyomtatón, több szögből, figyelni a darabokat, és
hiba kategóriának megfelelően jelezni amenyiben beavatkozásra van szükség. Az alapötlet: Egy olyan konvoluciós neuron háló
betanítása mely képes felismerni az alap hibákat, es ennek a beillesztése egy olyan keretrendszerbe, mely a tárgyasztalokat figyeli, különböző szögekből.