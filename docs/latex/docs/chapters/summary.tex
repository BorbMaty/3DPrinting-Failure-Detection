...
A rendszer három kameraállásból, kameránként tíz másodpercenként egy képkockát dolgoz fel, és magas prioritású hiba
észlelésekor e-mail értesítést küld a kezelőnek, egyetlen, az egész rendszerre közös 300 másodperces cooldown-nal a riasztásözön
...
\begin{itemize}
    ...
    \item \textbf{Rendszer szintű tesztelés és kiértékelés.} A jelenlegi fejlesztési szakaszban a
    rendszer egyes komponensei, modell, edge eszköz, felhőoldali pipeline, külön-külön lettek
    validálva. A következő lépés egy átfogó, végponttól végpontig tartó tesztelési terv kidolgozása
    és végrehajtása, amely a teljes rendszert valós nyomtatási környezetben, hosszabb időszakon
    keresztül vizsgálja. Ez magában foglalja a detekciós pontosság mérését éles körülmények között,
    a késleltetés és áteresztőképesség profilozását, a riasztások megbízhatóságának elemzését
    (hamis pozitív/negatív arány), valamint a rendszer stabilitásának és skálázhatóságának értékelését
    több nyomtató egyidejű felügyelete esetén.
\end{itemize}
