...
\begin{frame}{Élő rendszer – videó és e-mail riasztás}
  \begin{columns}[c]
    \column{0.58\textwidth}
      \centering
      \movie[loop,autostart,width=8.4cm,height=4.7cm]{}{figures/images/demo/video.mp4}
      \\[0.3em]
      {\small Valós idejű detekció – teljes pipeline}
    \column{0.40\textwidth}
      \centering
      \includegraphics[width=\textwidth,keepaspectratio]{demo/emailkep.png}
      \\[0.3em]
