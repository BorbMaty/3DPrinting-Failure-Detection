...
\begin{frame}{Áttekintés}
  \begin{enumerate}
    ...
    \item Problémafelvetés és motiváció
    \item Adathalmaz és tanítási stratégia
    \item Modell teljesítménye
    \item Rendszerarchitektúra és adatfolyam
    \item Összefoglalás és jövőbeli irányok
    \item Demó videó
  \end{enumerate}
\end{frame}
...
% ── Slide 4: Két súlyossági szint ────────────────────────────────────────────
\begin{frame}{9 hibaosztály – két súlyossági szint}
  \begin{columns}[T]
    \column{0.48\textwidth}
      \begin{alertblock}{Magas súlyosság – azonnali beavatkozás}
        \begin{itemize}
          \setlength\itemsep{0.4em}
          \item Spagetti
          \item Nem tapadó réteg
          \item Réteg-eltolódás
          \item Vetemedés
        \end{itemize}
        \vspace{0.3em}
        \centering{\small $\rightarrow$ \textbf{e-mail értesítés}}
      \end{alertblock}
    \column{0.48\textwidth}
      \begin{exampleblock}{Alacsony súlyosság – minőségromlás}
        \begin{itemize}
          \setlength\itemsep{0.4em}
          \item További 5 hibaosztály
          \item Operátori döntést igényelnek
          \item Fokozatos minőségromlást okoznak
        \end{itemize}
        \vspace{0.3em}
        \centering{\small $\rightarrow$ \textbf{csak naplózás (Firestore)}}
      \end{exampleblock}
  \end{columns}
\end{frame}

% ── Slide 5: 9 hibaosztály ────────────────────────────────────────────────────
...
\begin{frame}{9 detektált hibaosztály}
  ...
  \begin{tabular}{ccc}
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/spagetti.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/layer_shift.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/warping.jpg}} \\[0.1em]
    ...
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/not_sticking.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/under_extrusion.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/over_extrusion.jpg}} \\[0.1em]
    ...
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/stringing.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/nozzle_clog.jpg}} &
    \fbox{\includegraphics[width=2.9cm,height=1.7cm,keepaspectratio]{training_samples/foreign_object.jpg}} \\[0.1em]
...
% ── Slide 7: YOLOv8x + kétfázisú tanítás ─────────────────────────────────────
\begin{frame}{YOLOv8x – Kétfázisú tanítási stratégia}
  \begin{columns}[T]
    ...
    \column{0.46\textwidth}
      ...
      \end{alertblock}
      \vspace{0.4em}
      \begin{exampleblock}{Konfidenciaküszöb: 35\%}
        \centering
        Leggyengébb osztály csúcs F1 $\approx$ 0{,}38\\
        {\footnotesize(makró F1 csúcs = \textbf{0{,}88})}
      \end{exampleblock}
    \end{columns}
\end{frame}

% ── Slide 8: Tanítási görbék ──────────────────────────────────────────────────
...
% ── Slide 9: Konfúziós mátrix + PR görbe ─────────────────────────────────────
\begin{frame}{Konfúziós mátrix \& Precision-Recall görbe}
  \vspace*{-0.3em}
  \centering
  \includegraphics[width=0.49\textwidth,keepaspectratio]{results/y8x_phase2_12803/confusion_matrix_normalized.png}\hfill
  \includegraphics[width=0.49\textwidth,keepaspectratio]{results/y8x_phase2_12803/BoxPR_curve.png}
\end{frame}

% ── Slide 10: Validációs predikciók ───────────────────────────────────────────
...
% ── Slide 11: Összesített teljesítmény ───────────────────────────────────────
...
\begin{frame}{Élő dashboard}
  \centering
  \includegraphics[width=0.90\textwidth,keepaspectratio]{literature/full_dashboard.png}

  \vspace{0.35em}
  {\footnotesize 3 élő WebRTC kamerastream + valós idejű detekciós napló (Firestore onSnapshot)}
\end{frame}

% ── Slide 15: Összefoglalás + Jövőbeli irányok ───────────────────────────────
...
% ── Slide 16: Demó videó ──────────────────────────────────────────────────────
\begin{frame}{Videó bemutató}
  \centering
  % TODO: Embed or link demo video showing full end-to-end system
  \setlength\fboxsep{0.5cm}
  \fbox{\begin{minipage}{0.84\textwidth}
    \vspace{1.7cm}
    \centering\textcolor{gray!60}{\large [Demó videó – teljes rendszer, elejétől végéig – TODO]}\\[0.5em]
    {\small\textcolor{gray!50}{Raspberry Pi $\rightarrow$ Vertex AI $\rightarrow$ Dashboard $\rightarrow$ E-mail riasztás}}
    \vspace{1.7cm}
  \end{minipage}}
\end{frame}
